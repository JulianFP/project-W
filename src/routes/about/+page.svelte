...
<CenterPage title="What is Project W?">
  ...
  <Hr class="bg-gray-400 w-96 h-1 mx-auto my-4 rounded"/>
  <P>This project was created by <Span highlight="blue">Markus Everling</Span> and <Span highlight="blue">Julian Partanen</Span> as part of the software practical "Research Software Engineering" at the university of Heidelberg during the winter term 2023/24.</P>
</CenterPage>
