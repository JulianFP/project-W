...
<div class="mb-6 w-full">
  ...
  <Input wrapperClass="w-full" type={passwordVisible ? "text" : "password"} {id} name="password" color={error ? "red" : "default"} placeholder={passwordVisible ? "alice's password" : "••••••••••••••••"} required oninput={disableError} {...rest} bind:value={value}>
    {#snippet right()}
